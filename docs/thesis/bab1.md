...
Selain itu, kualitas solusi awal juga berperan penting dalam kinerja algoritma metaheuristik. Penggunaan Greedy Algorithm sebagai solusi awal telah terbukti efektif dalam meminimalkan pelanggaran hard constraints. Aksoy et al. ( 2021) melaporkan bahwa algoritma greedy mampu menghasilkan solusi dengan jumlah 0 pelanggaran hard constraints pada 18 dari 21 instance ITC-2007. Berdasarkan temuan tersebut, pendekatan hibrida SA–TS yang diawali dengan Greedy Algorithm sebagai Solusi awal dinilai sebagai strategi yang tepat untuk menyelesaikan UCTP.

Dari sisi implementasi sistem, pengembangan Decision Support System (DSS) berbasis web untuk penjadwalan perkuliahan menunjukkan trend yang semakin signifikan. Uysal et al. (2025) mengembangkan DSS berbasis web dengan algoritma SA yang mampu meningkatkan efisiensi penggunaan bandwidth serta pengelolaan koneksi secara simultan. Romaguera et al. (2024) mengembangkan sistem penjadwalan menggunakan Enhanced Genetic Algorithm dengan heuristic mutation, sedangkan Latpate et al. (2024) mengimplementasikan AI-based automatic timetable generator berbasis React yang mampu menghasilkan jadwal dalam hitungan menit dengan antarmuka yang intuitif.
...
2.	Bagaimana mengimplementasikan algoritma hibrida Simulated Annealing dan Tabu Search dengan Greedy Algorithm sebagai solusi awal untuk menyelesaikan UCTP?
...
Berdasarkan latar belakang di atas didapatkan tujuan dari penelitian ini sebagai berikut :
...
1.4	Batasan Masalah
Berdasarkan latar belakang di atas didapatkan batasan masalah dari penelitian ini sebagai berikut :
...
2.	Algoritma optimasi yang diimplementasikan adalah algoritma hibrida Simulated Annealing dan Tabu Search dengan Greedy Algorithm sebagai solusi awal.
...
4.	Penelitian ini fokus pada penjadwalan untuk satu semester akademik penuh

1.5	Manfaat Penelitian
Berdasarkan latar belakang di atas didapatkan manfaat dari penelitian ini sebagai berikut :
1.	Menambah literatur dalam bidang optimasi penjadwalan akademik dengan metaheuristik hibrida SA-TS dan Greedy.
...
5.	Menghasilkan jadwal yang lebih konsisten dan berkualita.
